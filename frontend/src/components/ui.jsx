...
export function StatCard({ label, value, sub, icon, accent }) {
  return (
    <Card accent={accent} className="p-5">
      ...
      <div className="font-mono text-xl font-medium" style={{ color: accent }}>
        {value}
      </div>
...
export function Button({
  ...
  const base =
    "px-4 py-2 rounded-lg text-sm font-semibold transition-opacity disabled:opacity-50 flex items-center gap-2";
  const variants = {
...
export function Badge({ children, color }) {
  return (
    <span
      className="inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-md bg-white/5 text-gray-400"
