  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            placeholder="R$ 0,00"
          />
          <Button onClick={saveSalary} variant="ghost">
            Salvar
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          label="Gastos"
          value={fmtBRL(b?.totalExpenses)}
          sub={`${b?.spendingPercent}% do salário`}
          icon="📤"
          accent="#f87171"
        />
        <StatCard
          label="Investido"
          value={fmtBRL(b?.totalInvestments)}
          sub="aporte do mês"
          icon="💎"
          accent="#a78bfa"
        />
      ...
      <Card className="p-5">
        ...
        <div className="flex h-6 rounded-lg overflow-hidden gap-0.5">
          {b?.salary > 0 && (
            <>
              <div
                style={{
                  width: `${Math.min(100, b.spendingPercent)}%`,
                  background: "#f87171",
                }}
              ...
              <div
                style={{
                  width: `${Math.min(100 - b.spendingPercent, b.salary > 0 ? (b.totalInvestments / b.salary) * 100 : 0)}%`,
                  background: "#a78bfa",
                }}
                className="flex items-center justify-center text-xs font-bold text-black/70 transition-all"
              >
                {b.salary > 0 &&
                  (b.totalInvestments / b.salary) * 100 > 8 &&
                  `${((b.totalInvestments / b.salary) * 100).toFixed(0)}%`}
              </div>
        ...
        <div className="flex gap-5 mt-3 text-xs text-gray-500">
          <span>
            <span className="inline-block w-3 h-3 rounded bg-red-400 mr-1.5 align-middle" />
            Gastos
          </span>
          <span>
            <span className="inline-block w-3 h-3 rounded bg-purple-400 mr-1.5 align-middle" />
            Investimentos
          </span>
          <span>
            <span className="inline-block w-3 h-3 rounded bg-green-500/40 mr-1.5 align-middle" />
            Saldo livre
          </span>
        </div>
      </Card>
